...
theorem abs_sub_lt_of_approx {a b c ε δ : ℝ} (h₁ : |a - b| ≤ δ) (h₂ : |b - c| < ε - δ) :
    |a - c| < ε := by
  have := (abs_sub_le a b c).trans_lt (add_lt_add_of_le_of_lt h₁ h₂)
  linarith
...
--   norm_num
-- end
theorem log_two_near_20 : |log 2 - 48427462327 / 69866059742| < 9 / 10 ^ 21 := by
  have t : |(3⁻¹ : ℝ)| = 3⁻¹ := abs_of_pos (by norm_num1)
  have z := newbound (by rw [t]; norm_num1 : |(3⁻¹ : ℝ)| < 1) 21
  rw [t, abs_sub_comm] at z
  norm_num1 at z
...
theorem log_three_div_two_near_20 : |log (3 / 2) - 31251726476 / 77076241213| < 1 / 10 ^ 22 := by
  have t : |(5⁻¹ : ℝ)| = 5⁻¹ := abs_of_pos (by norm_num1)
  have z := newbound (by rw [t]; norm_num1 : |(5⁻¹ : ℝ)| < 1) 17
  rw [t, abs_sub_comm] at z
  norm_num1 at z
  refine abs_sub_lt_of_approx z ?_
  simp_rw [sum_range_succ, sum_range_zero]
...
theorem log_four_div_three_near_20 :
    |log (4 / 3) - 4349275835861 / 15118341573370| < 1 / 10 ^ 26 := by
  have t : |(7⁻¹ : ℝ)| = 7⁻¹ := abs_of_pos (by norm_num1)
  have z := newbound (by rw [t]; norm_num1 : |(7⁻¹ : ℝ)| < 1) 16
  rw [t, abs_sub_comm] at z
  norm_num1 at z
  refine abs_sub_lt_of_approx z ?_
  simp_rw [sum_range_succ, sum_range_zero]
...
theorem log_nine_div_eight_near_20 :
    |log (9 / 8) - 26418276175004 / 224296105358295| < 3 / 10 ^ 29 := by
  have t : |(17⁻¹ : ℝ)| = 17⁻¹ := abs_of_pos (by norm_num1)
  have z := newbound (by rw [t]; norm_num1 : |(17⁻¹ : ℝ)| < 1) 12
  rw [t, abs_sub_comm] at z
  norm_num1 at z
  refine abs_sub_lt_of_approx z ?_
  simp_rw [sum_range_succ, sum_range_zero]
...
theorem log_two_near_20'' : |log 2 - 1148067618206 / 1656311459391| < 5 / 10 ^ 25 := by
  have :
    log 2 - (2 * 4349275835861 / 15118341573370 + 26418276175004 / 224296105358295) =
      2 * (log (2 * 2 / 3) - 4349275835861 / 15118341573370) +
        (log (3 * 3 / (2 * 2 * 2)) - 26418276175004 / 224296105358295) := by
  ...
  apply (add_lt_add_left (add_lt_add e₁ log_nine_div_eight_near_20) _).trans_le _
  rw [abs_of_nonneg]
  · norm_num1
  · norm_num1

theorem log_three_near_20 : |log 3 - 12397791320721 / 11284955983654| < 4 / 10 ^ 26 := by
  have :
    log 3 - (2 * (26418276175004 / 224296105358295) + 3 * (4349275835861 / 15118341573370)) =
      2 * (log (3 ^ 2 / 2 ^ 3) - 26418276175004 / 224296105358295) +
        3 * (log (2 ^ 2 / 3) - 4349275835861 / 15118341573370) := by
  ...
  apply (add_lt_add_left (add_lt_add e₂ e₁) _).trans_le _
  rw [abs_of_nonpos]
  · norm_num1
  · norm_num1
...
theorem log_64_div_63_near : |log (64 / 63) - 87664200650948 / 5566561694550313| < 4 / 10 ^ 32 := by
  have t : |(127⁻¹ : ℝ)| = 127⁻¹ := abs_of_pos (by norm_num1)
  have z := newbound (by rw [t]; norm_num1 : |(127⁻¹ : ℝ)| < 1) 8
  rw [t, abs_sub_comm] at z
  norm_num1 at z
  refine abs_sub_lt_of_approx z ?_
  simp_rw [sum_range_succ, sum_range_zero]
...
theorem abs_add_four (a b c d : ℝ) : |a + b + c + d| ≤ |a| + |b| + |c| + |d| :=
  (abs_add_le _ _).trans (add_le_add_left (abs_add_three _ _ _) _)

theorem log_seven_near : |log 7 - 5543595633008 / 2848844606571| < 6 / 10 ^ 24 := by
  have :
    log 7 -
      ...
      -1 * (log (2 ^ 6 / (3 ^ 2 * 7)) - 87664200650948 / 5566561694550313) +
        ...
        6 * (log 2 - 1148067618206 / 1656311459391) := by
  ...
  refine' (add_lt_add_left (add_lt_add (add_lt_add e₁ e₂) e₃) _).trans_le _
  rw [abs_of_nonpos]
  · norm_num1
  · norm_num1

theorem log_25_div_24_near : |log (25 / 24) - 7010006310925 / 171721308410023| < 4 / 10 ^ 30 := by
  have t : |(49⁻¹ : ℝ)| = 49⁻¹ := abs_of_pos (by norm_num1)
  have z := newbound (by rw [t]; norm_num1 : |(49⁻¹ : ℝ)| < 1) 9
  rw [t, abs_sub_comm] at z
  norm_num1 at z
  refine abs_sub_lt_of_approx z ?_
  simp_rw [sum_range_succ, sum_range_zero]
...
theorem log_five_near : |log 5 - 25218653206049 / 15669230239462| < 2 / 10 ^ 24 := by
  have :
    log 5 -
      ...
      1 / 2 * (log (5 ^ 2 / (2 ^ 3 * 3)) - 7010006310925 / 171721308410023) +
        ...
        3 / 2 * (log 2 - 1148067618206 / 1656311459391) := by
    rw [log_div, log_pow, log_mul, log_pow]
    · ring_nf
    all_goals norm_num
  rw [← sub_add_sub_cancel, this]
...
theorem log_8_div_7_near : |log (8 / 7) - 94488369352 / 707611652173| < 9 / 10 ^ 26 := by
  have t : |(15⁻¹ : ℝ)| = 15⁻¹ := abs_of_pos (by norm_num1)
  have z := newbound (by rw [t]; norm_num1 : |(15⁻¹ : ℝ)| < 1) 11
  rw [t, abs_sub_comm] at z
  norm_num1 at z
  refine abs_sub_lt_of_approx z ?_
  simp_rw [sum_range_succ, sum_range_zero]
...
theorem log_16_div_15_near : |log (16 / 15) - 2777280486178 / 43032911774627| < 7 / 10 ^ 28 := by
  have t : |(31⁻¹ : ℝ)| = 31⁻¹ := abs_of_pos (by norm_num1)
  have z := newbound (by rw [t]; norm_num1 : |(31⁻¹ : ℝ)| < 1) 10
  rw [t, abs_sub_comm] at z
  norm_num1 at z
  refine abs_sub_lt_of_approx z ?_
  simp_rw [sum_range_succ, sum_range_zero]
...
theorem log_33_div_32_near : |log (33 / 32) - 63667272858575 / 2069023108181113| < 3 / 10 ^ 31 := by
  have t : |(65⁻¹ : ℝ)| = 65⁻¹ := abs_of_pos (by norm_num1)
  have z := newbound (by rw [t]; norm_num1 : |(65⁻¹ : ℝ)| < 1) 9
  rw [t, abs_sub_comm] at z
  norm_num1 at z
  refine abs_sub_lt_of_approx z ?_
  simp_rw [sum_range_succ, sum_range_zero]
